...
public class SpringAiToolTest {
    ...
    public static McpSyncClient sseMcpClient() {
        ...
        // 自己申请 api_key http://appbuilder.baidu.com/v2/ai_search/mcp/sse?api_key=your-baidu-search-api-key
        HttpClientSseClientTransport sseClientTransport = HttpClientSseClientTransport.builder("http://appbuilder.baidu.com")
                .sseEndpoint("/v2/ai_search/mcp/sse?api_key=your-baidu-search-api-key")
                .build();
    ...
    public void test_url() throws MalformedURLException {
        String fullUrl = "http://appbuilder.baidu.com/v2/ai_search/mcp/sse?api_key=your-baidu-search-api-key";
